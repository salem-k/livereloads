...
export const myenterSearch = (_: HTMLElement, opts: any) => {
  ...
  if (!backDirection) {
    ...
    // .fromTo('transform', 'translateX(100%)', 'translateX(0%)')
      .beforeStyles({ 'border-radius': '20%','margin-top': '140%','margin-left':'20%', 'margin-right': '0%' })
      .keyframes([
        { offset: 0, transform: 'scale(0)' },
        { offset: 1, transform: 'scale(1)' }
      ])
      // .afterStyles({ 'border-radius': '0px', 'margin-top': '0%', 'margin-left': '0%' });
      .afterClearStyles(['width','margin-right','margin-top','border-radius','height','margin-left'])
